...
namespace UniRx.Triggers
{
    ...
    public static partial class ObservableTriggerExtensions
    {
        ...
        #region ObservablePointerClickTrigger

        /// <summary>This function is called when the MonoBehaviour will be destroyed.</summary>
        public static IObservable<PointerEventData> OnPointerClickAsObservable(this GameObject gameObject)
        {
            if (gameObject == null) return Observable.Return(default(PointerEventData)); // send destroy message
            return GetOrAddComponent<ObservablePointerClickTrigger>(gameObject).OnPointerClickAsObservable();
        }
